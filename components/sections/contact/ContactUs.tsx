            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">mohammednoorudheenmt@gmail.com</span>
                  <button
                    onClick={() => copyToClipboard('mohammednoorudheenmt@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+91 8075754525</span>
                  <button
                    onClick={() => copyToClipboard('+91 8075754525', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Ahmedabad, India</span>
                </div>
              </div>
            </motion.div>
